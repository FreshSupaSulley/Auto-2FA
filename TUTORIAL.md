...
### If the QR code didn't work
#### 5. Email code to yourself
<img width="296" alt="Get an activation link" src="public/images/universal/4.png">
...
#### 6. Activate
<img width="296" alt="Copy the code in the box" src="public/images/6.png">
...
### 1. Add a new device
<img width="296" alt="Add a new device" src="public/images/traditional/0.png">
Once you navigate to your organization's Duo Mobile device manager website, click the **Add a new Device** button.

### 2. Click Tablet, then iOS
<img width="296" alt="Click tablet, then iOS" src="public/images/traditional/1.png">
...
<img width="296" alt="Click I have Duo Mobile installed" src="public/images/traditional/2.png">
...
### If the QR code didn't work
#### 5. Email code to yourself
<img width="296" alt="Get an activation link" src="public/images/traditional/4.png">
If the QR code didn't work, click *Get an activation link* and get your inbox ready to receive the code. Duo will email you the activation code. Once you receive it, click the link provided in the email. Make sure you open this link on your computer and not your phone to prevent the Duo Mobile app from auto-opening it.
