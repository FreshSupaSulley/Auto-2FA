...
// This expects the format used when the code is sent to your inbox
...
document.getElementById("openOptions").addEventListener("click", () => {
  // https://developer.chrome.com/docs/extensions/develop/ui/options-page#linking
